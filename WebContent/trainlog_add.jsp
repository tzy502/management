...
<article class="page-container" id = 'form-item-add'>
	...
	<div class="row cl">
		...
		<input type="text" style='width:40%' class="input-text" value="" placeholder="时间" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"
					id="time" name="time">	
		</div>
	</div>
		<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<textarea name="traindetail" id='traindetail'  cols="" rows="" class="textarea" ></textarea>				
		</div>
	</div>
<center>
<div class="row cl">
