...
<article class="page-container" id = 'form-item-add'>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="number" class="input-text" value="" style='width:100%' placeholder="商品价格" id="supplieritemprice" name="supplieritemprice">
		</div>
	</div>
	<div class="row cl">
	...
	<input type="hidden" id="supplieritemId" name ="supplieritemId">
...
<script type="text/javascript">
	...
	Request = GetRequest();
	var supplieritemId = Request["supplieritemId"];
	...
	$(document).ready(function() {
		$.ajax({    
	        type: "post",    
	        async: true,    
	        url: "/management/searchsupplieritem.do",  
	        data: JSON.stringify(params),
	        dataType: "json", 
	        contentType: "application/json; charset=utf-8", 
	        success: function(data) { 	        	
	        	$("#supplieritemId").val(data.supplieritemId);
	        	$("#supplierId").val(data.supplierId);
	        	$("#supplieritemname").val(data.supplieritemname);
	        	$("#supplieritemprice").val(data.supplieritemprice);
	        	$("#time").val(data.supplieritemtime);
	        	$("#supplieritemtassess").val(data.supplieritemtassess);
	        }
	...
	$.ajax({
			...
			type: 'POST',
			url: "/management/modifrysupplieritem.do", 
			data:form, 
	        async: false,
	        processData:false,
	        contentType:false,
