...
<table class="table table-border table-bordered" id = 'checklist'>
  ...
  <tr>
    ...
    <td width="128" rowspan="5">&nbsp;
		<textarea name="" id='input51' cols="" rows="" class="textarea" ></textarea>
     	 校准系数： <br />
  ...
  <tr>
    <td width="119" colspan="3" rowspan="2">零点校准1 </td>
  ...
  <tr>
    ...
    <td width="81">测量量程 </td>
    <td width="90" colspan="3"><input type='text' value=''  id = 'input15' class='input-text radius size-S'></td>
