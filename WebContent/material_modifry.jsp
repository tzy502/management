...
<article class="page-container" id = 'form-item-add'>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" readonly="readonly" placeholder="余额" id="materialover" name="materialover">
		</div>
	</div>
...
function add(){
	...
	form.append("uesrId",getCookie("userId"))
	$.ajax({
			
			type: 'POST',
			url: "/management/modifryMaterial.do", 
			data:form, 
	        async: false,
	        processData:false,
	        contentType:false,
