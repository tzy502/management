...
<article class="page-container">
    ...
    <tr>
      ...
      <td width="259" colspan="7"><input type='text'  readonly="readonly"  value='' name='remotely' id = 'remotely' class='input-text radius size-S'>
</td>
    </tr>
    <tr>
      <td width="77"> 确认企业  </td>
      ...
      <td width="259" colspan="7"><input type='text' readonly="readonly"   value='' name='audit' id = 'audit' class='input-text radius size-S'>
</td>
    </tr>
		</table>	
