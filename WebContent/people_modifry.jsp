...
<article class="page-container" id = 'form-item-add'>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
				    <input type="radio" id="gender1" name="gender" checked  value=1>
...
$(document).ready(function() {
	$.ajax({    
        type: "post",    
        async: true,    
        url: "/management/searchpeople.do",  
        data: JSON.stringify(params),
        dataType: "json", 
        contentType: "application/json; charset=utf-8", 
        success: function(data) { 	        	
			var entrytime=data.entrytime;
			entrytime=entrytime.replace(/ 00:00:00.0/,"");
			var graduationtime=data.graduationtime;
			graduationtime=graduationtime.replace(/ 00:00:00.0/,"");
...
$.ajax({
		...
		type: 'POST',
		url: "/management/modifrypeople.do", 
		data:form, 
        async: false,
        processData:false,
        contentType:false,
