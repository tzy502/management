...
<form action="uploadDocument.do" id="upload"  method="post" enctype="multipart/form-data">  
	<div class="row cl">
	...
	<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>上传文件</label>
		<span class="btn-upload form-group">
		  <input class="input-text upload-url radius" type="text" name="uploadfile-1" id="uploadfile-1" readonly><a href="javascript:void();" class="btn btn-primary radius"> 浏览文件</a>
