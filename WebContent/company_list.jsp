...
<div class="page-container">	
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
		 <a href="javascript:;" onclick="add('添加企业','company_add.jsp','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加企业</a>
	 </span>  
	  </div>
	...
	$(document).ready(function (){
		$('body').on('click','#delete',function(event){
			...
			layer.confirm('确认要删除吗？',function(){
				...
				$.ajax({
					type: 'POST',
					url: "/management/delCompany.do", 
					data: JSON.stringify(params),
					dataType: 'json',
					contentType: "application/json; charset=utf-8",
					error:function(data) {
						layer.msg('删除失败!',{icon:1,time:15000});
						window.location.href = 'company_list.jsp';
					},
	...
	$.ajax({    
        ...
        success: function(data) { 
    		...
    		for(var i = 0; i < data.length; i++){     	
				...
				"<td>"+data[i].TEL+"</td>"+
				"<td class='td-manage'>"+
				"<a style='text-decoration:none' id = 'update' href='javascript:;' title='"+data[i].companyId+"'>"+
				"<i class='Hui-iconfont'>&#xe6df;</i>"+
			"</a>"+
				"<a style='text-decoration:none' id = 'delete' href='javascript:;' title='"+data[i].companyId+"'>"+
					"<i class='Hui-iconfont'>&#xe6e2;</i>"+
				"</a>"+
