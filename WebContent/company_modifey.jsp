...
<body>
	...
	<form class="form form-horizontal" id="add"  value="" >
		<div class="row cl">
		<input type="hidden" id="companyid" name="companyid">
			<label class="form-label col-xs-4 col-sm-3"><span
				class="c-red">*</span>公司名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="公司名称"
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="负责人"
					id="boss" name="boss">
			</div>
		</div>
		<center>
